...
import { PresenceEventsArg } from '../../common/types/event.types';
...
export declare class PresenceRoom {
     ...
     * @returns {void}
     */
    on<T extends unknown>(event: PresenceEventsArg, callback: PresenceCallback<T>, error?: ErrorCallback): void;
    /**
     * @function off
     ...
     * @returns {void}
     */
    off(event: PresenceEventsArg): void;
    /**
