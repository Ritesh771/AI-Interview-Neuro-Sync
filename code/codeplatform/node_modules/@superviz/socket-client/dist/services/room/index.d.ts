...
import { RoomEventsArg } from '../../common/types/event.types';
...
export declare class Room {
    ...
    constructor(io: Socket, user: Presence, roomId: string, apiKey: string, maxConnections?: number | 'unlimited');
    static register(io: Socket, presence: Presence, roomId: string, apiKey: string, maxConnections: number | 'unlimited'): Room;
    /**
     * @function on
     ...
     * @returns {void}
     */
    on<T>(event: RoomEventsArg, callback: Callback<T>): void;
    /**
     * @function off
     ...
     * @returns {void}
     */
    history<T = unknown>(next: (data: RoomHistory<T>) => void, error?: ErrorCallback): void;
    /**
     * @function disconnect
