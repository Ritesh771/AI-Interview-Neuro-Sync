import { Presence3D as AutodeskPresence3D } from '@superviz/autodesk-viewer-plugin';
import { Presence3D as MatterportPresence3D } from '@superviz/matterport-plugin';
import { default as React } from 'react';
import { SuperVizYjsProvider, CommentsComponent, DefaultComponentNames, FormElementsComponent, LauncherFacade, Participant, PointersCanvas, PointersHTML, RealtimeComponent, SuperVizSdkOptions, ThreeJsPresence3D, VideoConferenceComponent, WhoIsOnlineComponent } from '../lib/sdk';
...
export type SuperVizComponent = VideoConferenceComponent | CommentsComponent | PointersCanvas | PointersHTML | RealtimeComponent | WhoIsOnlineComponent | MatterportComponent | AutoDeskComponent | FormElementsComponent | ThreeJsComponent | SuperVizYjsProvider;
