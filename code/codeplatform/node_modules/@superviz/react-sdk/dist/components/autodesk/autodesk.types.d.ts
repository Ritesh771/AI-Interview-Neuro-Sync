...
export type AutodeskViewerComponentProps = {
    ...
    onDocumentLoadError?: (errorCode: Autodesk.Viewing.ErrorCodes, errorMsg: string, messages: any[]) => void;
    authUrl?: string;
...
} & Omit<AutodeskComponentProps, 'viewer' | 'children'> & Omit<React.HTMLAttributes<HTMLDivElement>, 'id'>;
export {};
//# sourceMappingURL=autodesk.types.d.ts.map